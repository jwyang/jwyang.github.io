...
<h2><img src="/images/fire.png" width="3%"/> <span style="color:red; font-family:Papyrus">News</span></h2>
 <img src="/images/dart.png" width="2.5%"/> \[12/2022\] We are release [X-Decoder](https://x-decoder-vl.github.io/), a generalist model for decoding pixel-level masks and token-level semantics seamlessly, achieving state-of-the-art open-vocab segmentation on 8 datasets, referring segmenation on RefCOCOg+ and instance/panoptic segmentation on ADE-20K!<br/>
