...
Most recently, I led the [**Project Magma**](https://microsoft.github.io/Magma/), which is the flagship project at MSR towards multimodal agentic foundation (<span style="color:red">**Top 1 ranked at Hacker News on 02.20.2025**</span>). Starting from now and further pushing forward, I believe we can achieve performant yet interpretable, grounded and robust multi-modality intelligent agents!
